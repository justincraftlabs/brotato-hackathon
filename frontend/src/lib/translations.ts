...
export const TRANSLATIONS = {
  ...
  CHAT_WELCOME_MESSAGE: {
    ...
    en: "Hello! I'm Brotato Assistant 🥔 What would you like to ask about your home's electricity?",
  },
  CHAT_INPUT_PLACEHOLDER: { vi: "Hỏi Khoai Tây...", en: "Ask Brotato..." },
  ...
  // Chat action confirmation card
  CHAT_ACTION_TITLE: { vi: "Xác nhận thay đổi", en: "Confirm change" },
  CHAT_ACTION_ADD_BADGE: { vi: "Thêm thiết bị", en: "Add appliance" },
  CHAT_ACTION_UPDATE_BADGE: { vi: "Sửa thiết bị", en: "Update appliance" },
  CHAT_ACTION_DELETE_BADGE: { vi: "Xóa thiết bị", en: "Delete appliance" },
  CHAT_ACTION_CREATE_ROOM_BADGE: { vi: "Tạo phòng mới", en: "Create new room" },
  CHAT_ACTION_ROOM_SIZE_LABEL: { vi: "Kích thước", en: "Size" },
  CHAT_ACTION_APPLIANCES_HEADING: { vi: "Thiết bị kèm theo", en: "Appliances" },
  CHAT_ACTION_ROOM_ALREADY_EXISTS: {
    vi: "Phòng đã tồn tại: {name}",
    en: "Room already exists: {name}",
  },
  CHAT_ACTION_SUCCESS_CREATE_ROOM: {
    vi: "✅ Đã tạo phòng **{room}** ({size}). Bạn có thể xem ở trang Thiết lập nhé!",
    en: "✅ Created room **{room}** ({size}). Check it in the Setup page!",
  },
  CHAT_ACTION_SUCCESS_CREATE_ROOM_WITH_APPLIANCES: {
    vi: "✅ Đã tạo phòng **{room}** ({size}) kèm {count} thiết bị. Xem ở trang Thiết lập nhé!",
    en: "✅ Created room **{room}** ({size}) with {count} appliance(s). Check the Setup page!",
  },
  CHAT_ACTION_SUCCESS_ADD: {
    vi: "✅ Đã thêm **{appliance}** vào phòng **{room}**.",
    en: "✅ Added **{appliance}** to **{room}**.",
  },
  CHAT_ACTION_SUCCESS_UPDATE: {
    vi: "✅ Đã cập nhật **{appliance}** trong phòng **{room}**.",
    en: "✅ Updated **{appliance}** in **{room}**.",
  },
  CHAT_ACTION_SUCCESS_DELETE: {
    vi: "✅ Đã xóa **{appliance}** khỏi phòng **{room}**.",
    en: "✅ Removed **{appliance}** from **{room}**.",
  },
  CHAT_ACTION_CANCELLED_CREATE_ROOM: {
    vi: "❎ Đã hủy tạo phòng **{room}**.",
    en: "❎ Cancelled creating room **{room}**.",
  },
  CHAT_ACTION_CANCELLED_ADD: {
    vi: "❎ Đã hủy thêm **{appliance}** vào phòng **{room}**.",
    en: "❎ Cancelled adding **{appliance}** to **{room}**.",
  },
  CHAT_ACTION_CANCELLED_UPDATE: {
    vi: "❎ Đã hủy cập nhật **{appliance}** trong phòng **{room}**.",
    en: "❎ Cancelled updating **{appliance}** in **{room}**.",
  },
  CHAT_ACTION_CANCELLED_DELETE: {
    vi: "❎ Đã hủy xóa **{appliance}** khỏi phòng **{room}**.",
    en: "❎ Cancelled removing **{appliance}** from **{room}**.",
  },
  CHAT_ACTION_ROOM_LABEL: { vi: "Phòng", en: "Room" },
  CHAT_ACTION_APPLIANCE_LABEL: { vi: "Thiết bị", en: "Appliance" },
  CHAT_ACTION_WATTAGE_LABEL: { vi: "Công suất", en: "Wattage" },
  CHAT_ACTION_HOURS_LABEL: { vi: "Giờ/ngày", en: "Hours/day" },
  CHAT_ACTION_STANDBY_LABEL: { vi: "Công suất chờ", en: "Standby" },
  CHAT_ACTION_TYPE_LABEL: { vi: "Loại", en: "Type" },
  CHAT_ACTION_HABIT_LABEL: { vi: "Thói quen", en: "Habit" },
  CHAT_ACTION_UPDATES_HEADING: { vi: "Cập nhật", en: "Updates" },
  CHAT_ACTION_APPLY: { vi: "Áp dụng", en: "Apply" },
  CHAT_ACTION_CANCEL: { vi: "Hủy", en: "Cancel" },
  CHAT_ACTION_APPLYING: { vi: "Đang áp dụng...", en: "Applying..." },
  CHAT_ACTION_APPLIED: { vi: "Đã áp dụng ✓", en: "Applied ✓" },
  CHAT_ACTION_FAILED: { vi: "Không thành công", en: "Failed" },
  CHAT_ACTION_CANCELLED: { vi: "Đã hủy", en: "Cancelled" },
  CHAT_ACTION_ROOM_NOT_FOUND: { vi: "Không tìm thấy phòng: {name}", en: "Room not found: {name}" },
  CHAT_ACTION_APPLIANCE_NOT_FOUND: { vi: "Không tìm thấy thiết bị: {name}", en: "Appliance not found: {name}" },
  CHAT_ACTION_RETRY: { vi: "Thử lại", en: "Retry" },
  ...
  EFFICIENCY_INFO_ROW_PLATINUM: { vi: "💎 Khoai Bạch Kim", en: "💎 Platinum Brotato" },
  EFFICIENCY_INFO_ROW_GOLD: { vi: "⭐ Khoai Vàng", en: "⭐ Gold Brotato" },
  EFFICIENCY_INFO_ROW_SPROUTING: { vi: "🌱 Khoai Nảy Mầm", en: "🌱 Sprouting Brotato" },
  EFFICIENCY_INFO_ROW_RAW: { vi: "🥔 Khoai Thô", en: "🥔 Raw Brotato" },
  ...
  EFFICIENCY_RANK_PLATINUM: { vi: "Khoai Bạch Kim", en: "Platinum Brotato" },
  EFFICIENCY_RANK_GOLD: { vi: "Khoai Vàng", en: "Gold Brotato" },
  EFFICIENCY_RANK_SPROUTING: { vi: "Khoai Nảy Mầm", en: "Sprouting Brotato" },
  EFFICIENCY_RANK_RAW: { vi: "Khoai Thô", en: "Raw Brotato" },
  EFFICIENCY_HINT_LOW: { vi: "Giảm standby để lên hạng 🌱", en: "Reduce standby to rank up 🌱" },
  EFFICIENCY_HINT_MED: { vi: "Gần tới Khoai Vàng rồi! ⭐", en: "Almost at Gold Brotato! ⭐" },
